...
class SecurityPlugin extends Injectable
{
    ...
    private function getAcl():AclList
    {
        ...
        $permissions = [];
        // set roles
        // Note migration: PermissionType peut ne pas exister sur ce projet (models non générés).
        // Fallback: rôles statiques pour permettre les tests API.
        ...
        $public = [
           'user'  => ['login', 'connect'],
           // JSON API auth endpoints (migration Supabase)
           'auth'  => ['login', 'register', 'me', 'refresh', 'logout'],
           // Temporaire: endpoints emails nécessaires au front (sync)
           'emails' => ['sync']
        ];
